...
// (fora do DOMContentLoaded para ficar no escopo global,
//  mas é chamado logo no início do DOMContentLoaded)
// ============================================
function startLogoSlider() {
  const track1 = document.getElementById('logosTrack1');
  const track2 = document.getElementById('logosTrack2');

  // Log de diagnóstico — remova depois que confirmar que funciona
  console.log('[Logos] track1:', track1, '| track2:', track2);
  ...
  console.log('[Logos] Track1 preenchido com', track1.children.length, 'itens');
  console.log('[Logos] Track2 preenchido com', track2.children.length, 'itens');
}n;
